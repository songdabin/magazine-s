...
<body>  
  ...
  <div class="mem-page">
  	<form action="${path}/resources/deleteuser.jsp" method="post">
	  	<div class="mem-menu">
	  		<div class="mem-name"><%=u.getName() %></div>
	  		<div class="mem-submenu">회원 정보</div>
	  		<a href="${path}"><input type="button" class="logout-btn" value="로그아웃"></a><a href="${path}/resources/deleteuser.jsp?id=<%=u.getId()%>"><input type="button" class="my-red-btn" value="회원탈퇴"></a>
	  	</div>
  	</form>
  	<form:form action="edituser.jsp" method="post"> 
