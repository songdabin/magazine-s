  	...
  	<div class="admin">	  	
		<table class="admin-table">  
			...
			<c:forEach items="${list}" var="u">  
				<tr><td class="admin-td">${u.getId()}</td><td class="admin-td">${u.getName()}</td><td class="admin-td">${u.getPassword()}</td>  
				<td class="admin-td">${u.getEmail()}</td><td class="admin-td">${u.getPhonenumber()}</td>
				<td class="admin-td"><a class="link" href="editform.jsp?id=${u.getId()}">Edit</a></td>  
				<td class="admin-td"><a class="link" href="deleteuser.jsp?id=${u.getId()}">Delete</a></td></tr>
			</c:forEach>  
		</table>
		
		<br/><a class="link" href="${path}/resources/userform.html">Add New User</a>
	</div>
